...
export function addEmailInstrumentation(params: {
  ...
  const logoHeader = params.logoUrl
    ? `<img
  src="${params.logoUrl}"
...
/>`
    : "";
  const footer = `<div style="font-family:Arial,sans-serif;font-size:12px;line-height:1.6;color:#64748b;margin-top:28px;padding-top:18px;border-top:1px solid #e2e8f0;">
